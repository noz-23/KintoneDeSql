...
/// </summary>
internal class RecordAclControl : BaseAppControl
{
    /// <summary>
    /// コンストラクタ
    /// </summary>
    public RecordAclControl() : base()
    {
        ControlMainTableName= RecordAclResponse.TableName(false);
    }
    ...
    public override async Task<int> ControlInsert(string appId_)
    {
        ...
        var response = await RecordAclRequest.Instance.Insert(appId_);
