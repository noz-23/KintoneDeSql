...
/// </summary>
internal class AppCustomizeControl : BaseAppControl
{
    /// <summary>
    /// コンストラクタ
    /// </summary>
    public AppCustomizeControl() : base()
    {
        ControlMainTableName= AppCustomizeResponse.TableName(false);
    }
    ...
    public override async Task<int> ControlInsert(string appId_, string apiKey_)
    {
        ...
        var response = await AppCustomizeRequest.Instance.Insert(appId_,apiKey_);
