...
/// </summary>
internal class UserResponse : ItemValue
{
    //id ID型 ユーザーID
    [JsonPropertyName("id")]
    ...
    //code    文字列 ログイン名 -> ResponseAccount
    ...
    //public string ListCustomItemValue { get; set; } = string.Empty;
    [ColumnEx("customItemValues", Order = 100, TypeName = "TEXT")]
    public ListCustomItemValueResponse ListCustomItemValue { get; set; } = new();
    //public List<CustomItemValueResponse> ListCustomItemValue { get; set; } = new();
