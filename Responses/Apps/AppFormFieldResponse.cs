...
internal class AppFormFieldResponse : BaseToData
{
    ...
    public List<EntryValue> ListEntitry { get; set; } = new();
    ...
    [ColumnEx("lookupt", Order = 101, IsExtract = true)]
    ...
    public Dictionary<string, AppFormFieldResponse> ListField { get; set; } = new();

    /// <summary>
    /// フィールドコードのKey
    /// </summary>
    [ColumnEx("fields_key", Order = 1, TypeName = "TEXT")]
